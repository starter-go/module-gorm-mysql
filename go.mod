module github.com/starter-go/module-gorm-mysql

go 1.18

require (
	github.com/starter-go/application v0.9.11
	github.com/starter-go/libgorm v0.9.5
	github.com/starter-go/starter v1.0.1 // direct
...
require (
	...
	github.com/starter-go/base v0.9.5 // indirect
